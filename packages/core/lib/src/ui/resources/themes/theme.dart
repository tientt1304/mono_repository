...
TextTheme textTheme({bool darkMode = false}) {
  ...
  return _textTheme.copyWith(
    bodySmall: _textStyle.copyWith(fontSize: smallText, fontWeight: FontWeight.w400, color: textColor),
    bodyMedium: _textStyle.copyWith(fontSize: normalText, fontWeight: FontWeight.w400, color: textColor),
    bodyLarge: _textStyle.copyWith(fontSize: largeText, fontWeight: FontWeight.w500, color: textColor),
    titleSmall: _textStyle.copyWith(fontSize: smallText, fontWeight: FontWeight.w500, color: textColor),
    titleMedium: _textStyle.copyWith(fontSize: mediumText, fontWeight: FontWeight.w500, color: textColor),
    titleLarge: _textStyle.copyWith(fontSize: largeText, fontWeight: FontWeight.w600, color: textColor),
  );
}
...
TextStyle titleStyle(ThemeData theme) => _textStyle.copyWith(
...
final hintStyle = _textStyle.copyWith(fontSize: smallText, color: DesignColors.grey);

final errorStyle = _textStyle.copyWith(fontSize: smallText, color: Colors.red);

final labelStyle = _textStyle.copyWith(fontSize: smallText, fontWeight: FontWeight.w500);

final textFieldStyle = _textStyle.copyWith(fontSize: 15, fontWeight: FontWeight.w500);
...
/// -------------------- TextStyles -------------------- ///
final veryLargeTextStyle = _textStyle.copyWith(fontSize: largeText, fontWeight: FontWeight.w700);
final largeTextStyle = _textStyle.copyWith(fontSize: mediumText, fontWeight: FontWeight.w600);
final mediumTextStyle = _textStyle.copyWith(fontSize: mediumText, fontWeight: FontWeight.w500);
final normalTextStyle = _textStyle.copyWith(fontSize: normalText, fontWeight: FontWeight.w500);
final smallTextStyle = _textStyle.copyWith(fontSize: smallText, fontWeight: FontWeight.w400);
final verySmallTextStyle = _textStyle.copyWith(fontSize: verySmallText, fontWeight: FontWeight.w400);
final titleTextStyle = _textStyle.copyWith(fontSize: mediumText, fontWeight: FontWeight.w600);
