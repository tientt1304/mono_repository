...
abstract class $BaseResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T? data, bool? success, String? message, int? statusCode});
}
...
class _$BaseResponseImpl<T> extends _BaseResponse<T> {
  const _$BaseResponseImpl({this.data, this.success, this.message, this.statusCode}) : super._();
  ...
  @override
  String toString() {
    return 'BaseResponse<$T>(data: $data, success: $success, message: $message, statusCode: $statusCode)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, const DeepCollectionEquality().hash(data), success, message, statusCode);
...
abstract class _BaseResponse<T> extends BaseResponse<T> {
  const factory _BaseResponse({final T? data, final bool? success, final String? message, final int? statusCode}) = _$BaseResponseImpl<T>;
